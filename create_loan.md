...
| `extension_count` | `numeric` | Has to be set if `extendable_schedule` is true. How many times loan can be extended. If LO has loan settings then this number may get limited, max 100 |,
